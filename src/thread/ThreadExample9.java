...
// 1. 메서드 전체를 임계 영역으로 지정하는 방법 - 현재 코드는 이 방법 이용
// 2. 특정한 영역을 임계 영역으로 지정하는 방법
public class ThreadExample9 {

    public static void main(String[] args) {

        Runnable threadTask9 = new ThreadTask10();
        Thread thread9_1 = new Thread(threadTask9);
        Thread thread9_2 = new Thread(threadTask9);

        thread9_1.setName("김멍멍");
        thread9_2.setName("박냥냥");
...
class ThreadTask9 implements Runnable {
